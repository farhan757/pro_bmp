...
unset($__errorArgs, $__bag); ?>                            
                        <div class="row px-3 mb-4">
                            <!--<div class="custom-control custom-checkbox custom-control-inline"> <input id="chk1" type="checkbox" name="chk" class="custom-control-input" <?php echo e(old('remember') ? 'checked' : ''); ?>> <label for="chk1" class="custom-control-label text-sm">Remember me</label> </div>-->
                        </div>
...
</html><?php /**PATH C:\xampp\htdocs\pro_bmp\resources\views/auth/login.blade.php ENDPATH**/ ?>